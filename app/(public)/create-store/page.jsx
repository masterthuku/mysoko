    ...
    try {
      ...
      if (["approved", "rejected", "pending"].includes(data.status)) {
        ...
        switch (data.status) {
          case "approved":
            setMessage(
              "Your store has been approved. You can now start adding products to your store."
            );
            setTimeout(() => {
          ...
          case "rejected":
            setMessage(
              "Your store has been rejected. Contact support for more information."
            );
            break;
          case "pending":
            setMessage(
              "Your store is currently under review. You will be notified once it is approved or rejected."
            );
            break;
          ...
          >
            ...
            <div>
              ...
              <p className="max-w-lg">
                To become a seller on mySoko, submit your store details for
